...
fibro = Diagnosis.create(user: bob, diagnosis: "Fibromyalgia")
back = Diagnosis.create(user: bob, diagnosis: "Back sprain")
uc = Diagnosis.create(user: tina, diagnosis: "Ulcerative colitis")
lupus = Diagnosis.create(user: bob, diagnosis: "Lupus")
scapula = Diagnosis.create(user: gene, diagnosis: "Scapula injury")

datetime0 = DateTime.new(2016,6,9,8,4,2)
datetime1 = DateTime.new(2016,6,10,12,5,6)
datetime2 = DateTime.new(2016,6,11,12,5,6)
datetime3 = DateTime.new(2016,6,12,12,5,6)
datetime4 = DateTime.new(2016,6,13,06,23,6)
datetime5 = DateTime.new(2016,6,14,20,5,6)
datetime6 = DateTime.new(2016,6,15,8,5,6)
datetime7 = DateTime.new(2016,6,16,12,5,6)
datetime8 = DateTime.new(2016,6,17,12,5,6)
datetime9 = DateTime.new(2016,6,18,12,5,6)


time_1 = datetime0.strftime('%FT%T%')
...
time_10 = datetime9.strftime('%FT%T%')
...
Entry.create(diagnosis: scapula, value: 5, time: time_10)
